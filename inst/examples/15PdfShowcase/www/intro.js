    function startIntro(){
        ...
        function checkExist(e) {
            ...
            if (typeof e.element !== 'undefined') {
                ...
                if (e.element !== null) {
                    if (e.parentElem !== 'undefined' && e.parentElem) {
                        e.element = e.element.parentElement;
                    }
                
                    top = e.element.offsetTop;
                }
                return (e.element !== null & $(e.element).is(":visible") & top != -9999); 
            } 
        ...
        var steps = [
                ...
                {
                    element: document.querySelector('#s1KpiDimensie'),
                ...
                {
                    element: document.querySelector('#s1KpiBreadcrumb'),
                    intro: "Navigeer met behulp van deze mappenstructuur naar de relevante groep indicatoren.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#s1KpiDimensie').querySelector(".dataTables_length"),
                    intro: "Kies hier het aantal indicatoren dat op één pagina getoond wordt.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#s1KpiDimensie').querySelector(".dataTables_filter"),
                    intro: "Type hier de naam of een deel van de naam van een indicator om deze te zoeken.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#s1KpiDimensie').querySelector(".dataTables_paginate"),
                    intro: "Spring snel naar een volgende pagina via deze paginanummers.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#s1KpiDimensie').querySelector(".kpiInfoAnchor"),
                    intro: "Bekijk de definitie van de indicator door op het i-bolletje te klikken.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#maatr'),
                    intro: "Hier kan een toelichting worden gegeven op het resultaat en kunnen er per groep van indicatoren maatregelen worden ingevoerd.",
                    position: 'right',
                    parentElem: true
                },
                {
                    element: document.querySelector('#ovz'),
                    intro: "Met deze optie kan de maandrapportage in PDF formaat worden aangemaakt. Hierbij worden de indicatoren in hoofdstukken getoond en, indien van toepassing, worden de eerder ingevoerde toelichtingen en maatregelen getoond. Er is ook nog ruimte voor het toevoegen van een conclusie.",
                    position: 'right'
                },
                {
                    element: document.querySelector('#s1KplDimensie'),
                ...
                {
                    element: document.querySelector('.s1Kpl_d7Sparkline'),
                    intro: "Deze lijngrafiekjes tonen de 'in de maand' stand van het verschil tussen realisatie en begroting.",
                    position: "right"
                },
                {
                    element: document.querySelector('#s1MndDimensie'),
                ...
                {
                    element: document.querySelector('#s1PerInstDimensie'),
                ...
                {
                    element: document.querySelector('#s1Kpl2Dimensie'),
                ...
                {
                    element: document.querySelector('#s1PerAfdDimensie'),
